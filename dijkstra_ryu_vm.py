...
def get_path (src,dst,first_port,final_port):
    ...
    localpath = []
    for i in range(2):
        if (originalsrc == vmpairs[0] and originaldst == vmpairs[1]) or (originalsrc == vmpairs[1] and originaldst == vmpairs[0]):
            if i==0:
                src = originalsrc
                dst = localswitches[0]
            else:
                src = localswitches[0]
                dst = originaldst
        elif (originalsrc == vmpairs[2] and originaldst == vmpairs[3]) or (originalsrc == vmpairs[3] and originaldst == vmpairs[2]):
            if i==0:
                src = originalsrc
                dst = localswitches[1]
            else:
