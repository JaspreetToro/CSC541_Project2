...
def get_path (src,dst,first_port,final_port):
    localswitches = [6,17] #src to 6, 6 to dest; src to 17, 17 to dest  ---start
    originalsrc = src
    originaldst = dst
    localpath = []
    for i in range(4):
        ...
        localpath.append(path)  #  ---start

    print ("path1: ", localpath[0], localpath[1])
    print ("path2: ", localpath[2], localpath[3])

    if (len(localpath[0]) + len(localpath[1])) < (len(localpath[2]) + len(localpath[3])):
        print ("shortest path: ", localpath[0], localpath[1])
        a = localpath[1][1:]
        path = localpath[0] + a
    else:
        print ("shortest path: ", localpath[2], localpath[3])
        a = localpath[3][1:]
        path = localpath[2] + a # ---end
    ...
    #print "Path from ", src , " to ", dst, " is: ", path
